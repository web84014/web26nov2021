        ...
        */
        ...
        DL_Bar_Chart: function( $scope ) {
            ...
            if( $ids ){
                ...
                let $chart_type = $settings.hasOwnProperty('chart_type') ? $settings.chart_type : 'x',
                ...
                if( $settings.labels !== ''){
                    $ctOptions.data.labels = $settings.labels;
                }

                if( $settings.datasets !== ''){
                    $ctOptions.data.datasets = $settings.datasets;
                }

                if( $settings.chart_type != ''){
                    $ctOptions.options.indexAxis = $settings.chart_type;
                }

                $ctOptions.options.maintainAspectRatio = false;
                $ctOptions.options.scales.y.beginAtZero = true;
