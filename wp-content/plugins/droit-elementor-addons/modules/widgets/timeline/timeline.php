    ...
    protected function register_timeline_repeater_for_second_layout(){
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .dl_timeline_section.dl_timeline_default_style .dl_timeline_coutent_inner' => 'left: {{SIZE}}{{UNIT}};',
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .dl_timeline_section.dl_timeline_default_style .dl_timeline_coutent_inner' => 'top: {{SIZE}}{{UNIT}};',
                   ...
                   <div <?php echo $timeline_inner_wraper; ?>>
                       ...
                       <div class="dl_timeline_main_coutent_inner droit-timeline-content-inner">
                           ...
                           <?php if ($this->get_timeline_settings('show_date_time') == 'yes'): ?>
                               <div class="dl_timeline_coutent_inner droit-timeline-date-time <?php echo esc_attr_e('elementor-repeater-item-'.$item['_id']);?>">
